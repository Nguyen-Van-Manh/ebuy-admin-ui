...
export namespace Login {
  ...
  export type UserWithTokenInlineFragment = (DiscriminateUnion<(NonNullable<LoginMutation['login']>), { __typename?: 'UserWithToken' }>);
  export type User = (NonNullable<(DiscriminateUnion<(NonNullable<LoginMutation['login']>), { __typename?: 'UserWithToken' }>)['user']>);
...
export namespace UserFragment {
  export type Fragment = UserFragmentFragment;
}
...
export type UserFragmentFragment = (
  { __typename?: 'User' }
  & Pick<User, '_id' | 'firstName' | 'lastName' | 'username' | 'email' | 'phoneNumber' | 'avatarURL' | 'active' | 'countryCode' | 'currency'>
);
